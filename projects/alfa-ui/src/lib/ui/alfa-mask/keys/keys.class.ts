...
export class Keys {
    ...
    // For Android
    public static whichKeyHasBeenPressed(
        txt1: string,
        txt2: string,
        selStart1: number,
        selStart2: number,
        ...
        if (selLength === 1) {
            if (txt1.substring(0, selStart2) === txt2.substring(0, selStart2)) {
                if (
                    txt1.substring(selStart1 + 1, txt1.length) ===
                    txt2.substring(selStart2, txt2.length)
                ) {
        ...
        if (txt1.substring(0, selStart1 - 1) === txt2.substring(0, selStart1 - 1)) {
            if (
                txt1.substring(selStart1, txt1.length) ===
                txt2.substring(selStart1 - 1, txt2.length)
            ) {
                return new KeyInfo(Keys.BACKSPACE);
            }
        }
        ...
        if (txt1.substring(0, selStart1) === txt2.substring(0, selStart1)) {
            if (
                txt1.substring(selStart1 + 1, txt1.length) ===
                txt2.substring(selStart1, txt2.length)
            ) {
