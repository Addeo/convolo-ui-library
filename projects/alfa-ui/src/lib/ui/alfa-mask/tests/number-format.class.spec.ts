...
describe('Parse format ~${N1-5.2}', () => {
    const fmt: NumberFormat = NumberFormat.parseFormat('~${N1-5.2}')!;
...
describe('Parse format "L = {E1.2-3} km"', () => {
    const fmt: NumberFormat = NumberFormat.parseFormat('L = {E1.2-3} km')!;
...
describe('Parse format "$ {+1-3.2}"', () => {
    const fmt: NumberFormat = NumberFormat.parseFormat('$ {+1-3.2}')!;
...
describe('Parse integer number format "{1-4}"', () => {
    const fmt: NumberFormat = NumberFormat.parseFormat('{1-4}')!;
